...
void gemm_1_run(const MatrixMap<const std::uint8_t, MapOrder::RowMajor>& lhs,
                const MatrixMap<const std::uint8_t, MapOrder::ColMajor>& rhs,
                MatrixMap<std::uint8_t, MapOrder::ColMajor>* result, int col_idx,
...
void gemm_2_run(const MatrixMap<const std::uint8_t, MapOrder::RowMajor>& lhs,
                const MatrixMap<const std::uint8_t, MapOrder::ColMajor>& rhs,
                MatrixMap<std::uint8_t, MapOrder::ColMajor>* result, int col_idx,
                int16_t lhs_offset_16, int16_t rhs_offset_16, int32_t result_offset,
                int32_t result_mult_int, int32_t result_shift) {
...
void gemm_3_run(const MatrixMap<const std::uint8_t, MapOrder::RowMajor>& lhs,
                const MatrixMap<const std::uint8_t, MapOrder::ColMajor>& rhs,
                MatrixMap<std::uint8_t, MapOrder::ColMajor>* result, int col_idx,
                int16_t lhs_offset_16, int16_t rhs_offset_16, int32_t result_offset,
                int32_t result_mult_int, int32_t result_shift) {
...
void gemm_4_run(const MatrixMap<const std::uint8_t, MapOrder::RowMajor>& lhs,
                const MatrixMap<const std::uint8_t, MapOrder::ColMajor>& rhs,
                MatrixMap<std::uint8_t, MapOrder::ColMajor>* result, int col_idx,
                int16_t lhs_offset_16, int16_t rhs_offset_16, int32_t result_offset,
                int32_t result_mult_int, int32_t result_shift) {
...
//template <>
void SingleThreadGemv(const MatrixMap<const std::uint8_t, MapOrder::RowMajor>& lhs,
                      const MatrixMap<const std::uint8_t, MapOrder::ColMajor>& rhs,
                      MatrixMap<std::uint8_t, MapOrder::ColMajor>* result, 
                      int32_t lhs_offset, int32_t rhs_offset, int32_t result_offset,
                      int32_t result_mult_int, int32_t result_shift) {
